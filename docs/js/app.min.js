...
"use strict";var _createClass=function(){function e(e,t){for(var n=0;n<t.length;n++){var a=t[n];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(e,a.key,a)}}return function(t,n,a){return n&&e(t.prototype,n),a&&e(t,a),t}}();function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}var DataStore=function(){function e(){_classCallCheck(this,e),this.cachename="rr-app",this.openDatabase()}return _createClass(e,[{key:"openDatabase",value:function(){var e=this;this.cache=idb.open(this.cachename,1,function(t){switch(t.oldVersion){case 0:e.createStore(t,"restaurants"),e.createStore(t,"reviews").createIndex("byRestaurant","restaurant_id"),e.createStore(t,"failedRequests",!0)}})}},{key:"createStore",value:function(e,t){var n=arguments.length>2&&void 0!==arguments[2]&&arguments[2];return e.createObjectStore(t,{keyPath:"_id",autoIncrement:n})}},{key:"getCachedData",value:function(e){return this.cache.then(function(t){return t.transaction(e).objectStore(e).getAll()})}},{key:"getCachedDataById",value:function(e,t){return this.cache.then(function(n){return n.transaction(e).objectStore(e).getAll(t)})}},{key:"getCachedDataByIndex",value:function(e,t,n){return this.cache.then(function(a){return a.transaction(e).objectStore(e).index(t).getAll(n)})}},{key:"getStoreKeys",value:function(e){return this.cache.then(function(t){return t.transaction(e).objectStore(e).getAllKeys()})}},{key:"cacheAll",value:function(e,t){this.cache.then(function(n){var a=n.transaction(e,"readwrite").objectStore(e);t.forEach(function(e){a.put(e)})})}},{key:"cacheOne",value:function(e,t){this.cacheAll(e,[t])}},{key:"deleteOne",value:function(e,t){this.cache.then(function(n){n.transaction(e,"readwrite").objectStore(e).delete(t)})}},{key:"deleteAll",value:function(e){this.cache.then(function(t){t.transaction(e,"readwrite").objectStore(e).clear()})}}]),e}();
"use strict";var _createClass=function(){function e(e,t){for(var a=0;a<t.length;a++){var n=t[a];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,a,n){return a&&e(t.prototype,a),n&&e(t,n),t}}();function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}var DBHelper=function(){function e(){_classCallCheck(this,e)}return _createClass(e,null,[{key:"getRestaurantURL",value:function(t){return e.RESTAURANTS_URL+"/"+t}},{key:"getReviewURL",value:function(t){return e.REVIEWS_URL+"/"+t}},{key:"getReviewsURLBasedOnRestaurant",value:function(t){return e.REVIEWS_URL+'?q={"restaurant_id":"'+t+'"}'}},{key:"isTemporaryId",value:function(e){return!!e.startsWith("temp")}},{key:"fetchData",value:async function(t){var a=new Request(t,{method:"GET",mode:"cors",cache:"reload",credentials:"same-origin",headers:e.REQUEST_HEADERS});try{var n=fetch(a),r=await n,i=await r.json();return Promise.resolve(i)}catch(e){throw Error(e)}}},{key:"getData",value:function(t,a,n){e.fetchData(t,a).then(function(t){var r={target:a};if("restaurants"===a||"reviews"===a){var i=t;r.data=i,e.updateIndexedDB(r,"GETALL")}else{var u=t;r.data=u,e.updateIndexedDB(r,"GET")}n(null,r.data)}).catch(function(e){return n(e,null)})}},{key:"updateIndexedDB",value:function(t,a){if(e.INDEXED_DB_SUPPORT)switch(a){case"GETALL":e.AppStore.cacheAll(t.target,t.data);break;case"DELETE":e.AppStore.deleteOne(t.target+"s",t.data._id);break;default:e.AppStore.cacheOne(t.target+"s",t.data)}}},{key:"fetchRestaurants",value:function(t){e.INDEXED_DB_SUPPORT?e.AppStore.getCachedData("restaurants").then(function(a){a.length&&(t(null,a),t=function(){}),e.AppStore.deleteAll("restaurants"),e.getData(e.RESTAURANTS_URL,"restaurants",t)}):e.getData(e.RESTAURANTS_URL,"restaurants",t)}},{key:"fetchRestaurantById",value:function(t,a){e.INDEXED_DB_SUPPORT?e.AppStore.getCachedDataById("restaurants",t).then(function(n){n.length&&(a(null,n[0]),a=function(){}),e.getData(e.getRestaurantURL(t),"restaurant",a)}):e.getData(e.getRestaurantURL(t),"restaurant",a)}},{key:"fetchReviews",value:function(t){e.INDEXED_DB_SUPPORT?e.AppStore.getCachedData("reviews").then(function(a){a.length&&(t(null,a),t=function(){}),e.AppStore.deleteAll("reviews"),e.getData(e.REVIEWS_URL,"reviews",t)}):e.getData(e.REVIEWS_URL,"reviews",t)}},{key:"fetchRestaurantReviews",value:function(t,a){e.INDEXED_DB_SUPPORT?e.AppStore.getCachedDataByIndex("reviews","byRestaurant",t).then(function(n){n.length&&(a(null,n),a=function(){}),e.getData(e.getReviewsURLBasedOnRestaurant(t),"reviews",a)}):e.getData(e.getReviewsURLBasedOnRestaurant(t),"reviews",a)}},{key:"fetchRestaurantByCuisineAndNeighborhood",value:function(t,a,n){e.fetchRestaurants(function(e,r){if(e)n(e,null);else{var i=r;"all"!==t&&(i=i.filter(function(e){return e.cuisine_type==t})),"all"!==a&&(i=i.filter(function(e){return e.neighborhood==a})),n(null,i)}})}},{key:"fetchUniqueRestaurantParams",value:function(t,a){e.fetchRestaurants(function(e,n){if(e)a(e,null);else{var r=n.map(function(e){return e[t]}),i=r.filter(function(e,t){return r.indexOf(e)==t});a(null,i)}})}},{key:"urlForRestaurant",value:function(e){return"restaurant.html?id="+e._id}},{key:"imageUrlForRestaurant",value:function(e){return"img/"+e.photograph+".jpg"}},{key:"favoriteHandler",value:function(t,a){var n={method:"PATCH",body:JSON.stringify({is_favorite:a})};return e.sendData(e.getRestaurantURL(t),n,"restaurant")}},{key:"postReview",value:function(t){var a={method:"POST",body:JSON.stringify(t)};return e.sendData(e.REVIEWS_URL,a,"review")}},{key:"updateReview",value:function(t){var a={method:"PATCH",body:JSON.stringify(t)};return e.sendData(e.getReviewURL(t._id),a,"review")}},{key:"deleteReview",value:function(t){if(e.isTemporaryId(t.toString()))return e.getTargetId(e.getReviewURL(t),"review").then(function(t){e.deleteExistingRequest({targetId:t,target:"review"});return{request_status:"fail",target:"review",data:[]}});return e.sendData(e.getReviewURL(t),{method:"DELETE"},"review")}},{key:"sendData",value:async function(t,a,n){var r=e.REQUEST_HEADERS;a.mode="cors",a.credentials="same-origin",a.headers=r,a.json=!0;var i=new Request(t,a);try{var u=fetch(i),s=await u,o=await s.json(),l={request_status:"success",target:n,data:o};return"DELETE"===a.method&&(l.data={_id:o.result[0]}),e.updateIndexedDB(l,a.method),Promise.resolve(l)}catch(r){var d=a;return d.target=n,d.url=t,d.data=[],e.handleFailedRequest(d)}}},{key:"getTargetId",value:function(t,a){var n=a+"s",r=t.split(n).pop();return"restaurant"===a?(r=r.split("/?is_favorite")[0],Promise.resolve(r.substring(1))):r?Promise.resolve(r.substring(1)):e.AppStore.getStoreKeys("failedRequests").then(function(e){return"temp"+(e.length+1)})}},{key:"deleteExistingRequest",value:function(t){e.AppStore.getCachedData("failedRequests").then(function(a){if(a.length){var n=a.filter(function(e){return e.target===t.target&&e.targetId===t.targetId});n.length&&e.AppStore.deleteOne("failedRequests",n[0]._id)}})}},{key:"handleFailedRequest",value:function(t){var a={request_status:"fail",target:t.target,data:t.data};return e.INDEXED_DB_SUPPORT?e.getTargetId(t.url,t.target).then(function(n){var r={target:t.target,url:t.url,method:t.method,targetId:n};if("body"in t){var i=JSON.parse(t.body);"_id"in i&&"id"in i||(i._id=n,i.id=n),r.body=i,a.data=i}return e.deleteExistingRequest(r),e.AppStore.cacheOne("failedRequests",r),Promise.resolve(a)}):Promise.resolve(a)}},{key:"sortByID",value:function(e,t,a){var n="asc"===a?-1:1;return e._id===t._id?0:e._id<t._id?n:-n}},{key:"sortByDate",value:function(e,t,a,n){return"asc"===a?parseFloat(new Date(e[n]).getTime())-parseFloat(new Date(t[n]).getTime()):parseFloat(new Date(t[n]).getTime())-parseFloat(new Date(e[n]).getTime())}},{key:"fetchFailedRequests",value:function(){return e.INDEXED_DB_SUPPORT?e.AppStore.getCachedData("failedRequests"):Promise.resolve([])}},{key:"clearIndexedBD",value:function(){e.AppStore.deleteAll("failedRequests"),e.AppStore.deleteAll("restaurants"),e.AppStore.deleteAll("reviews")}},{key:"RESTAURANTS_URL",get:function(){return appParams.endpoints.restaurants}},{key:"REVIEWS_URL",get:function(){return appParams.endpoints.reviews}},{key:"REQUEST_HEADERS",get:function(){var e=new Headers;return e.append("Accept","application/json; charset=UTF-8"),e.append("Content-type","application/json; charset=UTF-8"),e.append("x-apikey",appParams.databaseApiKey),e.append("cache-control","no-cache"),e}},{key:"INDEXED_DB_SUPPORT",get:function(){var e=window.indexedDB||window.mozIndexedDB||window.webkitIndexedDB||window.msIndexedDB,t=window.IDBTransaction||window.webkitIDBTransaction||window.msIDBTransaction||{READ_WRITE:"readwrite"},a=window.IDBKeyRange||window.webkitIDBKeyRange||window.msIDBKeyRange;return!!(e&&t&&a)}},{key:"AppStore",get:function(){return new DataStore}}]),e}();
