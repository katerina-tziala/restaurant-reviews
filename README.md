...
**5.**  Make sure that the ***app_params*** of in the *config.json* file inside the **gulp_tasks** folder are defined appropriately:
 - **_APP_PATH:** The url of the path of the app (e.g.: "http://localhost:<YOUR_PORT>/")
 - **_START_URL_:** The url of the index.html file (e.g.: "http://localhost:<YOUR_PORT>/index.html")
